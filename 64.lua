...
do 
    LPH_NO_VIRTUALIZE(function()
        --
        -- // Variables
        local ws, uis, rs, hs, cas, plrs, stats = cloneref(game:GetService("Workspace")), cloneref(game:GetService("UserInputService")), cloneref(game:GetService("RunService")), cloneref(game:GetService("HttpService")), cloneref(game:GetService("ContextActionService")), clonref(game:GetService("Players")), cloneref(game:GetService("Stats"))
        --
    ...
    local notifications = {}; do 
        ...
        function notifications.Notify(msg, time, color)
            ...
            task.spawn(function()
                connection = utility:Connection(rs.RenderStepped,function()
