...
Gradient = {
    ...
    gradient45n = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient(-45).png"; 
};
--
Arrow = {
...
Colorpicker = {
    ...
    cursor = "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/cpCursor.png";
...
do 
    LPH_NO_VIRTUALIZE(function()
        --
        -- // Variables
        local ws, uis, rs, hs, cas, plrs, stats = cloneref(game:GetService("Workspace")), cloneref(game:GetService("UserInputService")), cloneref(game:GetService("RunService")), cloneref(game:GetService("HttpService")), cloneref(game:GetService("ContextActionService")), cloneref(game:GetService("Players")), cloneref(game:GetService("Stats"))
        --
        ...
        do
            ...
            function utility:LoadImage(instance, imageName, imageLink)
                local data
                --
                if isfile(library.folders.assets.."/"..imageName..".clor") then
                    data = readfile(library.folders.assets.."/"..imageName..".clor")
                else
                    if imageLink then
                        data = game:HttpGet(imageLink)
                        writefile(library.folders.assets.."/"..imageName..".clor", data)
                    else
                        return
                    end
                end
        ...
        do
            ...
            function library:New(info)
                ...
                function window:GetConfig()
                    ...
                    --
                    return cloneref(game:GetService("HttpService")):JSONEncode(config)
                end
                --
                        ...
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and colorpicker_outline.Visible then
                            ...
                            elseif utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (colorpicker.index == 0 and (30 + 4 + 2) or (64 + 4 + 2))), section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.index == 1 and 36 or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                                if not colorpicker.open then
                                    ...
                                    utility:LoadImage(colorpicker_open_picker_cursor, "valsat_cursor","https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/cpCursor.png")
                    ...
                    library.began[#library.began + 1] = function(Input)
                        ...
                        if Input.UserInputType == Enum.UserInputType.MouseButton2 and window.isVisible and keybind_outline.Visible then
                            if utility:MouseOverDrawing({section.section_frame.Position.X  + (section.section_frame.Size.X - (40+4+2)), section.section_frame.Position.Y + keybind.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + keybind.axis + 17}) and not window:IsOverContent() and not keybind.selecting then
                                ...
                                --
                                utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient180.png")
                                --
            ...
            function sections:Slider(info)
                ...
                --
                utility:LoadImage(slider__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient(-45).png")
                --
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and dropdown_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + (name and (15 + 20) or (20))}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(dropdown__gradient, "gradientdown", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient180.png") 
                            end)
                            --
                ...
                library.began[#library.began + 1] = function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and multibox_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(multibox__gradient, "gradientdown", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient0.png") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradient180.png") 
                            end)
                            --
...
do 
    function notifications.UpdateNotifications()
        ...
        for _, v in pairs(notifications) do
            if v.holder then 
                local tweenObj = tween.new(v.holder, tweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = Vector2.new(20, 75 + (i * 30))})
                tweenObj:Play()
                i = i + 1
            end
        end
