...
do 
    LPH_NO_VIRTUALIZE(function()
        ...
        Notification = {
            ...
            Normal = Color3.fromRGB(theme["accent"]);
        ...
        do
            ...
            function utility:LoadImage(instance, imageName, imageLink)
                local data
                --
                if isfile(library.folders.assets.."/"..imageName..".Cd") then
                    data = readfile(library.folders.assets.."/"..imageName..".Cd")
                else
                    if imageLink then
                        data = game:HttpGet(imageLink)
                        writefile(library.folders.assets.."/"..imageName..".Cd", data)
                    else
                        return
                    end
                end
