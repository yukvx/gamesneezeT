...
do 
    LPH_NO_VIRTUALIZE(function()
        --
        -- // Variables
        local ws, uis, rs, hs, cas, plrs, stats = cloneref(game:GetService("Workspace")), cloneref(game:GetService("UserInputService")), cloneref(game:GetService("RunService")), cloneref(game:GetService("HttpService")), cloneref(game:GetService("ContextActionService")), cloneref(game:GetService("Players"), game:GetService("Stats"))
        --
