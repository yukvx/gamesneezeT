...
function window:Notification(info)
    ...
    local text_bounds = utility:GetTextBounds(notification_title, theme.textsize, theme.font)
    --
    local notification_outline = utility:Create("Frame", {Vector2.new(100,38/2-10)}, {
        Size = utility:Size(0, text_bounds.X+20, 0, 50),
    ...
    --
    local notification_title_label = utility:Create("TextLabel", {Vector2.new(2 + 6,4), notification_outline}, {
    ...
    --
    local notification_message_label = utility:Create("TextLabel", {Vector2.new(2 + 6,28), notification_outline}, {
        ...
        Hidden = true,
        ZIndex = 60,
        Position = utility:Position(0, 2 + 6, 0, 28, notification_outline),
        Visible = window.notification.visible
    })
    --
    ...
    function window.notification:UpdateSize()
        notification_outline.Size = utility:Size(0, notification_title_label.TextBounds.X + 4 + (6*2), 0, 50)
